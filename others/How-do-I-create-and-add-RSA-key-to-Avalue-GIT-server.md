...
1. Create RSA key of your Linux development platform.
    ...
    ![gen_rsa_key](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/gen_rsa_key.jpg)  
    ![rsa_key_copy](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/rsa_key_copy.jpg)  
...
2. Get access of Avalue GIT server (http://aes.avalue.com.tw). Please contact with Avalue sales people to get user name & password to access it.
    ![git_server_login](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/git_server_login.jpg)  

3. Once you log into Avalue GIT server, please click on “Profile Settings”
    ![git_profile_setting](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/git_profile_settings.jpg)  

    Then click on "SSH Keys"
    ![ssh_keys_aes](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/ssh_keys_aes.jpg)  

    Clink "Add SSH Key"
    ![ssh_keys_add](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/ssh_keys_add.jpg)  

    Just paste the content of id_rsa.pub in key area and press “Add key” button.
    ![ssh_keys_add2](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/ssh_keys_add2.jpg)  
    ...
    ![ssh_keys_add3](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/ssh_keys_add3.jpg)  

4. Try to download source code right now. Go to main page of Avalue git server. Select one of the project on the right.  
    ![git_select_project](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/git_select_project.jpg)  

    Copy the git link. You will also need branch version information to download source code (for example : 3.0.35-4.0.0)  
    ![git_link_branch](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/git_link_branch.jpg)  
    ...
    ![git_download](../imagesFAQ/How-do-I-create-and-add-RSA-key-to-Avalue-GIT-server/git_download.jpg)  